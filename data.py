...
if __name__ == "__main__":
    ...
    for key in rawpathdict.keys():
        ...
        temppaths = []
        pathdict[key] = {}
        get2levelfile(rawpathdict[key],temppaths)
        for k in temppaths :
    ...
    for key in pathdict.keys():
        ...
        for filepath in pathdict[key].values():
            ...
            rawdata = rawdata + res
        mkdir('./S1G/')
        with open('./S1G/'+key+'-RawData.json', "w", encoding="utf-8") as f:
        ...
        # data.append(replyer)
        # mkdir('./S1G/')
        # with open('./S1G/'+key+'-Data.json', "w", encoding="utf-8") as f:
